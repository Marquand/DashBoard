...
namespace Proxies\__CG__\PointWeb\NewsBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class News extends \PointWeb\NewsBundle\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'id', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'title', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'content', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'position', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'online', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'startDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'endDate', 'pictures', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'updateDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'createDate');
        }

        return array('__isInitialized__', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'id', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'title', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'content', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'position', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'online', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'startDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'endDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'updateDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'createDate');
    }
