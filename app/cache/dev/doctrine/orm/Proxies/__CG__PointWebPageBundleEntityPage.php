...
namespace Proxies\__CG__\PointWeb\PageBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Page extends \PointWeb\PageBundle\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PointWeb\\PageBundle\\Entity\\Page' . "\0" . 'id', '' . "\0" . 'PointWeb\\PageBundle\\Entity\\Page' . "\0" . 'title', '' . "\0" . 'PointWeb\\PageBundle\\Entity\\Page' . "\0" . 'path', '' . "\0" . 'PointWeb\\PageBundle\\Entity\\Page' . "\0" . 'content');
        }
